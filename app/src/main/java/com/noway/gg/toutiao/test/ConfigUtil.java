package com.noway.gg.toutiao.test;

import android.content.SharedPreferences;
import android.preference.PreferenceManager;

import com.noway.gg.toutiao.App;
import com.noway.gg.toutiao.AppContext;

/**
 * 包名:    com.noway.gg.toutiao.test
 * 标题:
 * 描述:    TODO
 * 作者:    NoWay
...
public class ConfigUtil {
    ...
    public static SharedPreferences getSharedPreferences() {
        if (sharedPreferences == null) {
            sharedPreferences = PreferenceManager.getDefaultSharedPreferences(AppContext.me());
        }
